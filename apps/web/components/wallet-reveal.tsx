...
/**
 * Cüzdan animasyonu: kart yelpazesi ve gizli bakiye reveal.
 * Mockup'taki orijinal layout korundu.
 */
export function WalletReveal({
  balance = '₺ 18.400,00',
  hint = 'Cüzdana dokun, birikimini gör',
}: Props) {
  return (
      ...
      <div className="wallet" aria-label="Niyet cüzdanı önizlemesi">
          ...
          <div className="card-inner">
            ...
            <div className="card-bottom">
              <div>
                ...
                <div className="value">AYŞE Y.</div>
              </div>
        ...
        <div className="card paypal">
          <div className="card-inner">
            ...
            <div className="card-bottom">
              <div>
                <span className="label">Hesap</span>
                <div className="value">ayse@niyet.app</div>
              </div>
              <div className="card-number-wrapper">
                <span className="label">Kart</span>
        ...
        <div className="pocket">
          <svg viewBox="0 0 280 160" width="280" height="160" aria-hidden>
            <path d="M0,30 Q0,0 30,0 L250,0 Q280,0 280,30 L280,160 L0,160 Z" fill="#1e341e" />
            <path
