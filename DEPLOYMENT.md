...
| Key                             | Değer                                                                                                                   | Notlar                                                                                                                                                                  |
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DATABASE_URL`                  | `postgresql://postgres.PROJECT:PWD@aws-0-eu-west-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1` | **Transaction pooler** (port 6543) — serverless için. **Local dev'de** `:5432/postgres?connection_limit=10` (session pooler) çok daha hızlı (prepared statement cache). |
