/* eslint-disable */
import type { Prisma, User, BankConnection, Account, Transaction, Subscription, AnalysisRun, TransactionAnalysis, Goal, GoalCheckpoint, GoalPriceHistory, GoalPriceAlert, Rule, Circle, CircleMembership, LearnDailyPack, LearnSourceSnapshot, LearnFact, LearnCard, LearnQuizItem, UserLearnState, UserLearnProgress, ChatSession, ChatMessage, MicroContribution, FutureScoreSnapshot, Notification } from "@prisma/client";
