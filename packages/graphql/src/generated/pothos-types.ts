/* eslint-disable */
import type { Prisma, User, BankConnection, Account, Transaction, Subscription, AnalysisRun, TransactionAnalysis, Goal, GoalCheckpoint, GoalPriceHistory, GoalPriceAlert, Rule, Circle, CircleMembership, ChatSession, ChatMessage, MicroContribution, FutureScoreSnapshot, Notification } from "@prisma/client";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "accounts" | "bankConnections" | "transactions" | "subscriptions" | "goals" | "rules" | "circleMemberships" | "notifications" | "futureScores" | "analysisRuns" | "microContributions" | "chatSessions";
        ListRelations: "accounts" | "bankConnections" | "transactions" | "subscriptions" | "goals" | "rules" | "circleMemberships" | "notifications" | "futureScores" | "analysisRuns" | "microContributions" | "chatSessions";
        Relations: {
            accounts: {
                Shape: Account[];
                Name: "Account";
