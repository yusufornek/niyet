/* eslint-disable */
import type { Prisma, User, MonthlyContributionTarget, CategorySpendingAlert, CategoryAutoSaveRule, BankConnection, Account, Transaction, Subscription, AnalysisRun, TransactionAnalysis, Goal, GoalCheckpoint, GoalPriceHistory, GoalPriceAlert, Rule, Circle, CircleMilestoneLog, CircleMembership, LearnDailyPack, LearnSourceSnapshot, LearnFact, LearnCard, LearnQuizItem, FinanceNewsItem, UserLearnState, UserLearnProgress, ChatSession, ChatMessage, MicroContribution, FutureScoreSnapshot, UserBadge, Notification } from "@prisma/client";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "accounts" | "bankConnections" | "transactions" | "subscriptions" | "goals" | "rules" | "circleMemberships" | "notifications" | "learnState" | "learnProgress" | "futureScores" | "badges" | "analysisRuns" | "microContributions" | "chatSessions" | "categoryAutoSaveRules" | "categorySpendingAlerts" | "monthlyContributionTarget";
        ListRelations: "accounts" | "bankConnections" | "transactions" | "subscriptions" | "goals" | "rules" | "circleMemberships" | "notifications" | "learnProgress" | "futureScores" | "badges" | "analysisRuns" | "microContributions" | "chatSessions" | "categoryAutoSaveRules" | "categorySpendingAlerts";
        Relations: {
            accounts: {
                Shape: Account[];
                Name: "Account";
            ...
            categoryAutoSaveRules: {
                Shape: CategoryAutoSaveRule[];
                Name: "CategoryAutoSaveRule";
                Nullable: false;
            };
            categorySpendingAlerts: {
                Shape: CategorySpendingAlert[];
                Name: "CategorySpendingAlert";
                Nullable: false;
            };
            monthlyContributionTarget: {
                Shape: MonthlyContributionTarget | null;
    ...
    MonthlyContributionTarget: {
        Name: "MonthlyContributionTarget";
        Shape: MonthlyContributionTarget;
        Include: Prisma.MonthlyContributionTargetInclude;
        Select: Prisma.MonthlyContributionTargetSelect;
        OrderBy: Prisma.MonthlyContributionTargetOrderByWithRelationInput;
        WhereUnique: Prisma.MonthlyContributionTargetWhereUniqueInput;
        Where: Prisma.MonthlyContributionTargetWhereInput;
        Create: {};
        Update: {};
        RelationName: "user";
        ListRelations: never;
    ...
    CategorySpendingAlert: {
        Name: "CategorySpendingAlert";
        Shape: CategorySpendingAlert;
        Include: Prisma.CategorySpendingAlertInclude;
        Select: Prisma.CategorySpendingAlertSelect;
        OrderBy: Prisma.CategorySpendingAlertOrderByWithRelationInput;
        WhereUnique: Prisma.CategorySpendingAlertWhereUniqueInput;
        Where: Prisma.CategorySpendingAlertWhereInput;
        Create: {};
        Update: {};
        RelationName: "user";
        ListRelations: never;
    ...
    CategoryAutoSaveRule: {
        Name: "CategoryAutoSaveRule";
        Shape: CategoryAutoSaveRule;
        Include: Prisma.CategoryAutoSaveRuleInclude;
        Select: Prisma.CategoryAutoSaveRuleSelect;
        OrderBy: Prisma.CategoryAutoSaveRuleOrderByWithRelationInput;
        WhereUnique: Prisma.CategoryAutoSaveRuleWhereUniqueInput;
        Where: Prisma.CategoryAutoSaveRuleWhereInput;
        Create: {};
        Update: {};
        RelationName: "user";
        ListRelations: never;
    ...
    Circle: {
        ...
        Create: {};
        Update: {};
        RelationName: "members" | "milestones";
        ListRelations: "members" | "milestones";
        Relations: {
            members: {
                Shape: CircleMembership[];
                Name: "CircleMembership";
            ...
            milestones: {
                Shape: CircleMilestoneLog[];
                Name: "CircleMilestoneLog";
                Nullable: false;
            };
        };
    };
    CircleMilestoneLog: {
        Name: "CircleMilestoneLog";
        Shape: CircleMilestoneLog;
        Include: Prisma.CircleMilestoneLogInclude;
        Select: Prisma.CircleMilestoneLogSelect;
        OrderBy: Prisma.CircleMilestoneLogOrderByWithRelationInput;
        WhereUnique: Prisma.CircleMilestoneLogWhereUniqueInput;
        Where: Prisma.CircleMilestoneLogWhereInput;
        Create: {};
        Update: {};
        RelationName: "circle";
        ListRelations: never;
    ...
    UserBadge: {
        Name: "UserBadge";
        Shape: UserBadge;
        Include: Prisma.UserBadgeInclude;
        Select: Prisma.UserBadgeSelect;
        OrderBy: Prisma.UserBadgeOrderByWithRelationInput;
        WhereUnique: Prisma.UserBadgeWhereUniqueInput;
