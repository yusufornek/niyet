/* eslint-disable */
import type { Prisma, User, MonthlyContributionTarget, CategorySpendingAlert, CategoryAutoSaveRule, BankConnection, Account, Transaction, Subscription, AnalysisRun, TransactionAnalysis, Goal, GoalCheckpoint, GoalPriceHistory, GoalPriceAlert, Rule, Circle, CircleMembership, LearnDailyPack, LearnSourceSnapshot, LearnFact, LearnCard, LearnQuizItem, FinanceNewsItem, UserLearnState, UserLearnProgress, ChatSession, ChatMessage, MicroContribution, FutureScoreSnapshot, UserBadge, Notification } from "@prisma/client";
