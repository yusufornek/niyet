/* eslint-disable */
import type { Prisma, User, BankConnection, Account, Transaction, Subscription, AnalysisRun, TransactionAnalysis, Goal, GoalCheckpoint, Rule, Circle, CircleMembership, MicroContribution, FutureScoreSnapshot, Notification } from "@prisma/client";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "accounts" | "bankConnections" | "transactions" | "subscriptions" | "goals" | "rules" | "circleMemberships" | "notifications" | "futureScores" | "analysisRuns" | "microContributions";
        ListRelations: "accounts" | "bankConnections" | "transactions" | "subscriptions" | "goals" | "rules" | "circleMemberships" | "notifications" | "futureScores" | "analysisRuns" | "microContributions";
        Relations: {
            accounts: {
                Shape: Account[];
                Name: "Account";
    ...
    Goal: {
        ...
        Create: {};
        Update: {};
        RelationName: "user" | "checkpoints" | "microContributions";
        ListRelations: "checkpoints" | "microContributions";
        Relations: {
            user: {
                Shape: User;
                Name: "User";
